...
// Insert into database with the current timestamp
$sql = "INSERT INTO calculations (shape, dimensions, area, unit, timestamp) 
        VALUES ('$shape', '$dimensions', '$area', '$unit', NOW())";

if ($conn->query($sql) === TRUE) {
    echo "Calculation saved successfully. Area: $area $unit<sup>2</sup>";
} else {
